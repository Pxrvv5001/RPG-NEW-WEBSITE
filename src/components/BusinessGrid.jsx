...
const BusinessGrid = () => {
    ...
    return (
        // Added 'dark:bg-[#0f172a]' and 'transition-colors'
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
                    {businesses.map((biz) => (
                        <motion.div
                            ...
                            whileHover={{ y: -8 }}
                            // Added 'dark:bg-[#1e293b]' for dark mode card background
                        ...
                        >
                            {/* Icon color changes in dark mode */}
                                        ...
                                        >
                                            ...
                                            <div className="p-8 md:p-10 md:w-3/5 bg-black/20">
                                                ...
                                                >
                                                    ...
                                                    <button className="w-full py-3 bg-white text-black font-bold uppercase tracking-widest text-xs hover:bg-[#d97706] hover:text-white transition-colors duration-300">
                                                        {biz.details.cta}
                                                    </button>
                                                </motion.div>
                                            </div>
