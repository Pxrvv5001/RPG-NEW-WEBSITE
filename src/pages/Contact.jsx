...
const Contact = () => {
        ...
        return (
            <div className="bg-white dark:bg-[#0f172a] min-h-screen font-sans transition-colors duration-500">
                ...
                <div className="max-w-4xl mx-auto px-6 py-32 text-center">
                    <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl p-12 shadow-lg">
    ...
    return (
        // Added 'dark:bg-[#0f172a]' for page background
        <div className="bg-white dark:bg-[#0f172a] min-h-screen font-sans transition-colors duration-500">
            <Header />
            ...
            <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div className="space-y-8">
                    {/* Added 'dark:bg-[#1e293b]' and 'dark:border-slate-700' */}
                    ...
                    <div className="h-64 rounded-xl overflow-hidden shadow-lg border border-gray-200 dark:border-slate-700 transition-all duration-500">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3294.588800664828!2d76.98218497533058!3d29.688229875104927!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390e7022e3722017%3A0x42af99a573aa933!2s1493%2C%20Sadar%20Bazar%20Rd%2C%20Ramesh%20Nagar%2C%20Karnal%2C%20Haryana%20132001!5e1!3m2!1sen!2sin!4v1766485921924!5m2!1sen!2sin"
                            width="100%"
                            height="100%"
                            style={{ border: 0 }}
                            allowFullScreen=""
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                {/* Inputs now have dark mode colors */}
                                <input
                                    id="name"
                                    type="text"
                                    name="name"
