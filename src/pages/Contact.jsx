            ...
            <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div className="space-y-8">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-500 dark:text-stone-500 text-xs mt-1">Mon-Sat, 9am - 8pm</p>
                                </div>
                            </div>
                    ...
                    <div className="h-64 rounded-xl overflow-hidden shadow-lg border border-gray-200 dark:border-white/10 transition-all duration-500">
                        <iframe
                            title="Karnal Map"
                            // ▼▼▼ FIXED: Uses a standard Karnal, Haryana embed link ▼▼▼
