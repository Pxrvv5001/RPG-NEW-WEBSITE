                ...
                <div className="max-w-4xl mx-auto px-6 py-32 text-center">
                    ...
                    >
                        ...
                        <p className="text-green-700 dark:text-green-300 text-lg mb-8">
                            Thank you for contacting R.P. Goyal & Sons. We have received your inquiry.
                        </p>
    ...
    return (
        <div className="bg-white dark:bg-[#1c1c1c] min-h-screen font-sans transition-colors duration-500">
            <Helmet>
                ...
                <meta name="description" content="Get in touch for timber inquiries." />
            </Helmet>
            ...
            <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div className="space-y-8">
                    {/* Changed Card BG to Stone-800 (#292524) */}
                ...
                <motion.div
                    ...
                    // Changed Form BG to Stone-800 (#292524)
                ...
                >
                    ...
                    <p className="text-gray-500 dark:text-stone-400 text-sm mb-8">Fill out the form below.</p>

                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label className="block text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-stone-400 mb-2">Name</label>
                                <input id="name" type="text" name="name" required className="w-full bg-gray-50 dark:bg-[#1c1c1c] border border-gray-200 dark:border-white/10 rounded p-3 text-gray-900 dark:text-white focus:outline-none focus:border-[#d97706] transition-all" placeholder="Parv Goyal" />
                            </div>
                            <div>
                                <label className="block text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-stone-400 mb-2">Phone</label>
                                <input id="phone" type="tel" name="phone" required className="w-full bg-gray-50 dark:bg-[#1c1c1c] border border-gray-200 dark:border-white/10 rounded p-3 text-gray-900 dark:text-white focus:outline-none focus:border-[#d97706] transition-all" placeholder="+91 98..." />
                            </div>
                        </div>
                        <div>
                            <label className="block text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-stone-400 mb-2">Email</label>
                            <input id="email" type="email" name="email" required className="w-full bg-gray-50 dark:bg-[#1c1c1c] border border-gray-200 dark:border-white/10 rounded p-3 text-gray-900 dark:text-white focus:outline-none focus:border-[#d97706] transition-all" placeholder="john@company.com" />
                        </div>
                        <div>
                            ...
                            <select id="interest" name="interest" defaultValue={initialInterest} className="w-full bg-gray-50 dark:bg-[#1c1c1c] border border-gray-200 dark:border-white/10 rounded p-3 text-gray-900 dark:text-white focus:outline-none focus:border-[#d97706] transition-all">
                        ...
                        <div>
                            ...
                            <textarea id="message" name="message" required rows="4" className="w-full bg-gray-50 dark:bg-[#1c1c1c] border border-gray-200 dark:border-white/10 rounded p-3 text-gray-900 dark:text-white focus:outline-none focus:border-[#d97706] transition-all" placeholder="Tell us about your requirements..."></textarea>
                        </div>

                        <button type="submit" disabled={state.submitting} className="w-full bg-[#1c1c1c] dark:bg-white text-white dark:text-black font-bold uppercase tracking-widest py-4 rounded hover:bg-[#d97706] dark:hover:bg-[#d97706] dark:hover:text-white transition-colors duration-300 flex items-center justify-center gap-2">
