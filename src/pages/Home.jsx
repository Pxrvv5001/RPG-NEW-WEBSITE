                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6">
                    ...
                    >
                        {importRoutes.map((route) => (
                            <div
                                key={route.id}
                                className="flex items-center gap-1.5 md:gap-2 bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-full px-3 py-1.5 md:px-4 md:py-2 text-[10px] md:text-xs text-gray-700 dark:text-white/80 hover:bg-gray-50 dark:hover:bg-white/10 hover:border-gray-300 dark:hover:border-white/20 shadow-sm dark:shadow-none transition-all cursor-default"
                            >
                                <span
